...
@Autonomous (name = "NewCrater", group = "ds")
...
//                    robot.robotStuff.BLeft.setPower(1);
//                    robot.robotStuff.BRight.setPower(-1);
                    newState(State.STATE_STOPL);
                }
                break;

            case STATE_STOPL:
                if (Runtime.milliseconds() > 900) { //moved up 100 each
                    robot.stop();
                }
                break;
